...
const seasons = {
    ...
    28: 26279,
    29: 27703,
    30: 999999, // must exist to define (inferred) end of prior season
        ...
        data() {
            return {
                ...
                seasonOptions: [
                    ...
                    {text: "Season 29", value: 29},
                    {text: "Season 28", value: 28},
            ...
            seasonFilteredData() {
                if (this.seasonMode < 1 || this.seasonMode > Object.keys(seasons).length) {
                    ...
                    return this.rawData.map(x => {
                        ...
                        return ret;
                    }).filter(x => x.count >= 5 || (this.seasonMode == 29/* update for new season */ && x.count >= 1)).sort(champComparator);
                }
            },
            mostRecentChamp() {
                let mostRecent = 0;
